...
browser.get("https://travel.liontravel.com/search?DepartureID=&ArriveID=--2,&GoDateStart=2024-06-08&GoDateEnd=2024-09-06&Keywords=&TravelType=1&IsSold=true&Platform=APP")
...
title_locator = (By.CLASS_NAME, 'title--1dhv-') #以標題定位By.XPATH, '//*[@id="root"]/div/div[4]/div/div[1]/div[1]/img
hotel_locator = (By.XPATH,'//*[@id="schedules"]/div[2]/div[2]/div/div[3]/div[2]')
            ...
            try:
                ...
                try:
                    ...
                    if check_List.text == "列表顯示":
                        ActionChains(browser).click(check_List).perform()
                        print(check_List.text)
                        WebDriverWait(browser, 10, 0.2).until(EC.presence_of_element_located(date_locator))
                        main_bar = browser.find_element(By.XPATH,'//*[@id="root"]/div/div[4]/div/div[1]/div[3]/div/div[2]/div/div[2]/div[1]/section[1]').find_elements(By.TAG_NAME, "div")
                try:
                                ...
                                try:
                                    ...
                                    for fulltrip in full_trip_message:
                                        ...
                                        for trip in fullfind:
                                            print("Day:"+str(count)+trip.text)
                                            full_tripList.append("Day:"+str(count)+trip.text)
                                            count += 1
...
data.to_csv("liontrip_0607.csv",encoding="utf-8", index=False)