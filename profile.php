				...
				<div class="row">
                    ...
                    <div class="col-sm-4">
						<div class="row">
							...
							<div class="col-sm-6">
								<input type="text" name="account" disabled value="<?php echo $memberInfo['account'];?>">
							</div>
                        </div><br />
						<div class="row">
							<div class="col-sm-6">
							...
							<div class="col-sm-6">
								<input type="text" name="fullname" value="<?php echo $memberInfo['fullname'];?>">
							</div>
                        </div><br />
                       	<div class="row">
							<div class="col-sm-6">
							...
							<div class="col-sm-6">
								<input type="email" name="email" value="<?php echo $memberInfo['email'];?>">
							</div>
                        </div><br />
						<div class="row">
							<div class="col-sm-6">
							...
							<div class="col-sm-6">
								<input type="text" name="tel" value="<?php echo $memberInfo['tel'];?>">
							</div>
                        </div><br />
						<div class="row">
							<div class="col-sm-12">
